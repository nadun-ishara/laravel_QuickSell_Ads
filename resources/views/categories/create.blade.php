        ...
        <div class="flex justify-between items-center">
            <div>
                ...
                <p class="text-[10px] font-bold text-slate-400 mt-1 uppercase tracking-widest leading-none">
                    Add new classifications for advertisements
                </p>
            </div>
            <a href="{{ route('categories.index') }}" class="text-[10px] font-black text-slate-400 hover:text-indigo-600 uppercase tracking-widest transition-colors">
                ← Back to List
            </a>
        </div>
    </x-slot>
            ...
            <div class="bg-white rounded-[2.5rem] shadow-xl shadow-slate-200/50 border border-slate-100 overflow-hidden">
                <div class="p-10">
                    <form action="{{ route('categories.store') }}" method="post" class="space-y-8">
                        ...
                        <div class="space-y-2">
                            <label class="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] ml-2">Category Name</label>
                            <input type="text" name="name" placeholder="e.g. Electronics, Vehicles"
                        ...
                        <div class="space-y-2">
                            <label class="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] ml-2">Parent Category (Optional)</label>
                            <div class="relative">
                            ...
                            <p class="text-[9px] text-slate-300 font-medium ml-2 uppercase tracking-tighter italic">Leave as Main Category if this is a top-level group.</p>
                        </div>
